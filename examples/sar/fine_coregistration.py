...
if __name__ == "__main__":
    ...
    shifts = coregistration.subpixel_shifts(pair.master.metadata, pair.slave.metadata, int(pair.shift_x), int(pair.shift_y), pair.master.slcdata.read(), pair.slave.slcdata.read(), output=tools.output_console, points=3200)
    ...
    im1 = ax1.imshow(pred_dx1, extent=[0, pair.master.metadata.number_columns, 0, pair.master.metadata.number_rows], origin='lower', cmap='viridis')
    ...
    im2 = ax2.imshow(pred_dy1, extent=[0, pair.master.metadata.number_columns, 0, pair.master.metadata.number_rows], origin='lower', cmap='viridis')
    ...
    # Plot the estimated dx shifts
    im1 = ax1.imshow(pred_dx2, extent=[0, pair.master.metadata.number_columns, 0, pair.master.metadata.number_rows], origin='lower', cmap='viridis')
    ...
    # Plot the estimated dy shifts
    im2 = ax2.imshow(pred_dy2, extent=[0, pair.master.metadata.number_columns, 0, pair.master.metadata.number_rows], origin='lower', cmap='viridis')
