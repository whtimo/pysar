...
sys.path.extend(['/home/timo/src/pysar'])
...
if __name__ == "__main__":
    ...
    tsx_path = '/home/timo/Data/SouthAfrica_2/cossc/dims_op_oc_dfd2_696749819_1/TDM.SAR.COSSC/1967680_002/TDM1_SAR__COS_BIST_SM_S_SRA_20230303T162519_20230303T162527/TSX1_SAR__SSC_BRX2_SM_S_SRA_20230303T162519_20230303T162527/TSX1_SAR__SSC_BRX2_SM_S_SRA_20230303T162519_20230303T162527.xml'
    srtm_path = '/home/timo/Data/SouthAfrica_2/srtm_43_17.tif'

    output_geo_tiff = '/home/timo/Data/SouthAfrica_2/tsx_20230303.tiff'

    slc_full = slc.fromTSX(tsx_path, 0)
    slc = slc_full.multilook(1, 1)

    sar_data = np.abs(slc.slcdata.read())
    ...
    easts, norths = transformer_geo.transform(lons, lats)
    es = (easts - ul_utm[0]) / pix_size
    ns = (ul_utm[1] - norths) / pix_size

    grid_size = (new_height, new_width)
    interpolate_x = interpolate_phase_residuals_natural_neighbor(es.reshape(-1), ns.reshape(-1),
                                                               sar_x.reshape(-1), grid_size)

    interpolate_y = interpolate_phase_residuals_natural_neighbor(es.reshape(-1), ns.reshape(-1),
                                                                 sar_y.reshape(-1), grid_size)


    print('Interpolate SAR image')
    new_geo_sar = map_coordinates(sar_data, [[interpolate_y], [interpolate_x]], order=2, mode='constant', cval=0)[0]
