...
class ReadTsxTest(unittest.TestCase):
    ...
    def test_readTsx_RapaNui(self):
        ...
        pos = slc.metadata._burst.orbit.positions[0]
        vel = slc.metadata._burst.orbit.velocities[1]
        ...
        self.assertEqual(1, slc.metadata._orbit.reference_time.second)
        ...
        self.assertEqual(42300.0, slc.metadata._burst._prf)
        self.assertEqual(300000000.0, slc.metadata._burst._total_bandwidth_range)
        ...
        self.assertEqual(1.0 / slc.metadata._burst._prf, slc.metadata._burst.row_spacing)
